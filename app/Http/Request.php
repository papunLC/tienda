...
class Request
{
    ...
    {
        $aux = strtolower($this->controller); // convierte a minuscula
        $aux = ucfirst($aux); // coloca la primer letra en mayuscula
        $aux = '\App\Http\Controllers\\' .$aux . 'Controller'; // concatenando + Controller
        return $aux;
    }
